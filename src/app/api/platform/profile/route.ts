...
export async function GET() {
  try {
    ...
    // platform.log("[PROFILE API] Getting profile for email:", session.user.email);
    ...
    // platform.log("[PROFILE API] Fetching user data for ID:", userId);
    ...
    // platform.log("[PROFILE API] Profile data assembled:", profileData);
...
export async function PUT(request: NextRequest) {
  try {
    ...
    // platform.log("[PROFILE API] Updating phone number for user ID:", userId, "with value:", phone_number);
    ...
    // platform.log("[PROFILE API] Strapi update result:", updateResult);
