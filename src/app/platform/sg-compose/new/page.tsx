...
const recipients = [
  ...
  { value: "ug2026", label: "UG2026", description: "ug2026@ashoka.edu.in" }
];
  ...
  const handleSubmit = async (action: 'request' | 'cancel') => {
    if (action === 'request') {
      ...
      try {
        ...
        platform.log('HTML content being submitted:', mailDraft);
        ...
        if (attachedFiles.length > 0) {
          ...
          platform.log('Submitting form data with files');
          ...
          platform.log('Submitting JSON data:', jsonData);
