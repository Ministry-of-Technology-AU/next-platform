...
export function CycleStatsBar({ stats }: { stats: CycleStats & { activeCyclesCount?: number } }) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <StatCard icon={Eye} label="Total Opens" value={stats.totalOpens || 0} accent="secondary" />
      <StatCard icon={Compass} label="Total Drafts" value={stats.totalDrafts || 0} accent="green" />
...
export function SingleCycleStatsBar({
  ...
  const currentDrafts = stats?.totalDrafts || 0;
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <StatCard icon={Compass} label="Total Drafts" value={currentDrafts} accent="green" />
