# Graph Report - next-platform  (2026-08-29)

## Corpus Check
- 617 files · ~1,297,625 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3675 nodes · 8965 edges · 238 communities (207 shown, 31 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 129 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9e357dea`
...
- `DELETE()` --calls--> `strapiDelete()`  [INFERRED]
  src/app/api/platform/sports/apl/matches/[id]/route.ts → src/lib/apis/strapi.ts
- `GET()` --calls--> `strapiGet()`  [INFERRED]
  src/app/api/platform/sports/apl/matches/route.ts → src/lib/apis/strapi.ts
- `BlockCardHeader()` --calls--> `isInputBlock()`  [INFERRED]
  src/app/organisations/forms/[formId]/edit/_components/builder-canvas.tsx → src/lib/forms/schema.ts
...
Cohesion: 0.16
Nodes (15): CGPAPlanner(), gradePointsMap, CGPAPlannerPage(), fetchCGPAData(), useCalculations(), saveCGPAData(), SemesterNavigationProps, AttemptSource (+7 more)

### Community 1 - "Community 1"
Cohesion: 0.13
Nodes (33): POST(), RouteContext, summarize(), DELETE(), POST(), PUT(), saveForm(), schemaHasInputBlock() (+25 more)
...
Cohesion: 0.08
Nodes (18): ArchivePuzzle, ArchivesPage(), getArchiveData(), AssetCard(), formatDateIST(), dashboardColumns(), DashboardEmail, DashboardPage() (+10 more)

### Community 5 - "Community 5"
Cohesion: 0.18
Nodes (5): Developer, DeveloperCredits(), DeveloperProps, DismissNewToolAlert(), Loader()

### Community 6 - "Community 6"
Cohesion: 0.16
Nodes (28): GET(), POST(), RouteContext, requireOrgSession(), requireOrgAccount(), requireRoleAccess(), sendApplicantStatusEmail(), deleteRole() (+20 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (29): createBlock(), createPage(), defaultSettings, FormBlock, FormBlockType, FormPage, FormSettings, FormStatus (+21 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (27): metadata, nunito, nunitoSans, Announcement(), AnnouncementProps, AnnouncementTag(), AnnouncementTagProps, AnnouncementTitle() (+19 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (46): LIVE_MATCH_FALLBACK, MOCK_GROUPS, MOCK_PAST_MATCHES, MOCK_TOP_SCORERS, MOCK_UPCOMING_MATCHES, MVPS, WINNERS, formatMatchDateTime() (+38 more)

### Community 10 - "Community 10"
Cohesion: 0.15
Nodes (21): DatePicker(), MultiSelectDropdown(), BlockInput(), BlockInputProps, parseDateValue(), DividerDisplay(), ImageDisplay(), ParagraphDisplay() (+13 more)

### Community 11 - "Community 11"
Cohesion: 0.15
Nodes (10): ExpandableText(), PageTitle(), CourseReviewsLayout(), getReviewCount(), FormsPage(), getForms(), FormsPage(), getForms() (+2 more)

### Community 12 - "Community 12"
Cohesion: 0.10
Nodes (28): MemberTag(), MemberTagProps, RichTextRenderer(), sanitizeHtml(), truncateEmail(), useClickOutside(), MorphingDialog(), MorphingDialogClose() (+20 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (44): Combobox(), ComboboxContent(), ComboboxContentProps, ComboboxContext, ComboboxContextType, ComboboxCreateNewProps, ComboboxData, ComboboxEmpty() (+36 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (29): EMPTY_STARTER_IDS, PersistedMatchClockState, STARTING_PLAYER_COUNT_OPTIONS, CGPAFormProps, ConfettiEffect(), ConfettiEffectProps, InviteFriendDialogProps, NewRoleDialog() (+21 more)

### Community 15 - "Community 15"
Cohesion: 0.14
Nodes (27): GET(), ALLOWED_ATTR, ALLOWED_TAGS, ensureLinkHardeningHook(), sanitizeFormSchema(), sanitizeHtml(), sanitizeResponseRichText(), FormResponseData (+19 more)

### Community 16 - "Community 16"
Cohesion: 0.09
Nodes (16): FormContainer(), MultiSelectCheckbox(), PhoneInput(), SingleSelect(), TextInput(), Section1BData, Section1BProps, Section2Data (+8 more)
...
Cohesion: 0.09
Nodes (22): CheckboxComponent(), CheckboxComponentProps, DatePickerProps, DateTimePickerProps, DropdownOption, FileUploadProps, FormContainerProps, ImageUpload() (+14 more)
...
Cohesion: 0.12
Nodes (22): ConfirmationScreen(), PageNavigator(), PageNavigatorProps, SubmissionPreview(), Answers, FillerClient(), initialAnswers(), Phase (+14 more)

### Community 22 - "Community 22"
Cohesion: 0.07
Nodes (40): createCalendarEvent(), formatLocalDateTime(), getAllExistingEvents(), getEventsOnHolidays(), getNextDateForDay(), parseTime(), POST(), ScheduledCourse (+32 more)
...
Cohesion: 0.13
Nodes (17): CourseListEditor(), CreditRequirements, CreditRequirementsEditor(), CreditRequirementsEditorProps, ExistingTrajectory, SemesterInTrajectory, TrajectoryEditor(), TrajectoryEditorProps (+9 more)

### Community 25 - "Community 25"
Cohesion: 0.10
Nodes (29): APLAuctionPage(), AuctionRow, formatAsMillions(), priceBands, tierClass, CourseItem, CourseListEditorProps, CREDIT_OPTIONS (+21 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (37): ArchiveEntry, GameData, GameState, Guess, KeyboardState, LeaderboardEntry, LetterEvaluation, LetterState (+29 more)

### Community 27 - "Community 27"
Cohesion: 0.16
Nodes (14): DELETE(), POST(), strapiPut(), EventsCalendarPreferences, validatePreferences(), GET(), getDefaultPreferences(), POST() (+6 more)

### Community 28 - "Community 28"
Cohesion: 0.13
Nodes (13): banners, banners, recentlyVisited, tailwindSafelist, Advertisement, BannerButton, ButtonVariant, TextStyle (+5 more)

### Community 29 - "Community 29"
Cohesion: 0.15
Nodes (15): createRecordFromStrapiMatch(), extractRelationId(), FixedKnockoutBracket, getTeamLogoUrl(), getTeamName(), KNOCKOUT_ROUND_ALIASES, KNOCKOUT_ROUNDS, KnockoutMatchRecord (+7 more)

### Community 30 - "Community 30"
Cohesion: 0.11
Nodes (33): AvailableCoursesTray(), CourseCard(), CourseCardProps, CoursePlannerBoard(), TourStep(), SemesterColumn(), SemesterColumnProps, ShareTrajectoryDialogProps (+25 more)
...
Cohesion: 0.09
Nodes (51): CycleClient(), CyclePage(), getCycle(), getRoles(), PageProps, DELETE(), GET(), PUT() (+43 more)
...
Cohesion: 0.15
Nodes (18): convertSurveyToCSV(), ensureSurveysDir(), GET(), getUserFilePaths(), hashEmail(), POST(), readJsonSubmissions(), SURVEYS_DIR (+10 more)
...
Cohesion: 0.10
Nodes (49): deleteImageFromCloudinary(), uploadRawToCloudinary(), StrapiFilters, FormFillerPage(), PageProps, rateLimit(), createDefaultSchema(), attrs() (+41 more)

### Community 44 - "Community 44"
Cohesion: 0.18
Nodes (12): CategoryColors, CategoryColorsContext, CategoryColorsContextType, CategoryColorsProvider(), useCategoryColors(), FiltersSidebar(), OrganizationCard(), SearchBar() (+4 more)
...
Cohesion: 0.19
Nodes (18): buildProxyErrorResponse(), extractStrapiValidationMessage(), extractTeamId(), findMatchRoundIndex(), listMatchesForKnockoutPropagation(), normalizeDetailsPayload(), normalizeKnockoutWinnerId(), normalizeMatchPayload() (+10 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (39): Accordion11(), Accordion11Content(), Accordion11ContentProps, Accordion11Item(), Accordion11ItemProps, Accordion11Props, Accordion11Trigger(), Accordion11TriggerProps (+31 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (76): AuroraBackground(), AuroraBackgroundProps, ComboboxCreateNew(), EditorProps, InductionCatalogCard(), InitiativeCredits(), InitiativeCreditsProps, InitiativePartner (+68 more)
...
Cohesion: 0.09
Nodes (14): isInputBlock(), BlockPreview(), ResponseDetail(), ResponseRow, BlockInspector(), renderDisplayFields(), renderInputExtras(), renderTypeFields() (+6 more)
...
Cohesion: 0.14
Nodes (15): NotFound(), bookInterviewSlot(), collectOrgEmails(), getPipelineRoundDetails(), InterviewBookingClient(), InterviewBookingPage(), InterviewPageProps, GET() (+7 more)

### Community 63 - "Community 63"
Cohesion: 0.11
Nodes (25): BlockBase, CheckboxBlock, DateBlock, DateTimeBlock, DISPLAY_BLOCK_TYPES, DividerBlock, EmailBlock, ImageBlock (+17 more)
...
Cohesion: 0.18
Nodes (18): computeCourse(), computeRow(), defaultScoreForLetter(), getLetterFromPercentage(), gradeOptions, letterRanges, LETTERS, newComponent() (+10 more)
...
Cohesion: 0.33
Nodes (7): AshokanAroundPage(), existAccommodationRequest(), AccommodationConnectionListing, GenderPreferenceFilter, HousingPreference, UserData, AshokanAroundForm()
...
Cohesion: 0.07
Nodes (50): CycleCard(), CycleStatsBar(), CycleFormDialog(), CycleFormDialogProps, NewCycleDialog(), DEFAULT_ROUNDS, FormMode, PipelineBuilder() (+42 more)
...
Cohesion: 0.28
Nodes (11): ApplicantStatus, buildBrandedEmailHtml(), buildResponseEmailHtml(), escapeHtml(), formatAnswer(), getOrgDetails(), OrgEmailDetails, profileEmail() (+3 more)
...
Cohesion: 0.31
Nodes (14): checkGrievanceSubmittedAsync(), getCookieName(), getLsKey(), GrievanceCacheRecord, isGrievanceSubmitted(), openGrievanceDB(), readFromCookie(), readFromIndexedDB() (+6 more)

### Community 78 - "Community 78"
Cohesion: 0.19
Nodes (13): GlobalTourPopover(), TourContext, TourContextType, TourOverlay(), TourProviderProps, TourStepConfig, TourTrigger(), useDisableMouseScroll() (+5 more)
...
Cohesion: 0.05
Nodes (45): INPUT_BLOCK_TYPES, baseSchema, blockId, buildResponseValidator(), checkboxBlock, collectInputBlocks(), conditionOperator, conditionRule (+37 more)

### Community 82 - "Community 82"
Cohesion: 0.38
Nodes (5): BackButton(), BackButtonProps, fetchJson(), PageProps, ResponsesPage()
...
Cohesion: 0.07
Nodes (29): AnimatedSearchProps, FormData, Asset, AssetDialog(), AssetRequestDialogProps, formatDate(), FormData, CGPAOverview() (+21 more)
...
Cohesion: 0.18
Nodes (15): BorrowAssetsClient(), BorrowAssetsClientProps, Asset, AssetStatus, AssetTab, AssetType, BorrowRequest, CreateBorrowRequestData (+7 more)
...
Cohesion: 0.13
Nodes (9): FileUpload(), InstructionsField(), frequencyOptions, Section4Data, Section4Props, Editor, mailCategories, recipients (+1 more)
...
Cohesion: 0.07
Nodes (34): DateTimePicker(), PRESETS, WordleHeaderProps, FormThemeRootProps, FontConfig, FormTheme, FormThemeColors, CURATED_FONTS (+26 more)
...
Cohesion: 0.18
Nodes (10): InductionSidebarProps, FilterCategory, OrganizationFiltersProps, defaultColors, DeadlineExtension, FilterOptions, InductionCycleEntry, OpenPosition (+2 more)
...
Cohesion: 0.08
Nodes (24): ActiveAccommodationRequest(), ActiveAccommodationRequestProps, AccommodationData, ApplicationCard(), SingleCycleStatsBar(), InductionSidebar(), NotificationsPopover(), RoleStatsBar() (+16 more)

### Community 213 - "Community 213"
Cohesion: 0.07
Nodes (28): PLATFORM_LABELS, PageFooterProps, PageTabsProps, FillerClientProps, ConditionOperator, ConditionRule, FormSchema, RuleGroup (+20 more)

### Community 214 - "Community 214"
Cohesion: 0.21
Nodes (9): PageFooter(), DEFAULT_INPUT_TITLES, fallbackTitle(), normalizeBlock(), normalizeOptions(), BuilderClient(), BuilderClientProps, SaveState (+1 more)
...
Cohesion: 0.36
Nodes (8): isFrontendFormat(), parseGradeDataText(), sanitizeCGPAData(), CORS_HEADERS, jsonResponse(), OPTIONS(), POST(), withCors()

### Community 218 - "Community 218"
Cohesion: 0.07
Nodes (41): GET(), uploadImageToCloudinary(), ArchivePuzzle, GET(), GET(), POST(), GET(), ArchivePageProps (+33 more)
...
Cohesion: 0.33
Nodes (3): scaleOptions, Section3Data, Section3Props

### Community 223 - "Community 223"
Cohesion: 0.05
Nodes (55): axiosConfig, buildQueryString(), normalizeEndpoint(), strapi, StrapiCallProps, strapiDelete(), StrapiFields, strapiGet() (+47 more)

### Community 224 - "Community 224"
Cohesion: 0.50
Nodes (3): OutboxEmail, ComposeOutboxPage(), getData()

### Community 225 - "Community 225"
Cohesion: 0.24
Nodes (8): FlickeringGrid(), FlickeringGridProps, DashboardStats(), defaultStats, getData(), Home(), BentoGrid(), BentoGridItem()

### Community 226 - "Community 226"
Cohesion: 0.40
Nodes (3): ALL_POPULAR_TOOLS, ASHOKA_ADMIN_TOOL_IDS, PopularToolsGridProps

### Community 229 - "Community 229"
Cohesion: 0.21
Nodes (11): ApplicationCardProps, InductionCatalogCardProps, NotificationsPopoverProps, OrganizationCardProps, PopulatedResponseRecord, InductionClient(), InductionClientProps, fetchInductionData() (+3 more)
...
Cohesion: 0.50
Nodes (3): Section7(), Section7Data, Section7Props
...
Cohesion: 0.67
Nodes (3): fetchJson(), PageProps, ResponsesPage()

### Community 236 - "Community 236"
Cohesion: 0.50
Nodes (3): BLOCK_META, BlockMeta, PALETTE_GROUPS

## Knowledge Gaps
- **1331 isolated node(s):** `{fontFamily}`, `{fontFamily}`, `$schema`, `style`, `rsc` (+1326 more)
...
- **Why does `Button()` connect `Community 84` to `Community 2`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 16`, `Community 19`, `Community 21`, `Community 22`, `Community 24`, `Community 25`, `Community 26`, `Community 28`, `Community 30`, `Community 158`, `Community 32`, `Community 38`, `Community 39`, `Community 41`, `Community 42`, `Community 44`, `Community 47`, `Community 48`, `Community 56`, `Community 58`, `Community 60`, `Community 188`, `Community 67`, `Community 70`, `Community 72`, `Community 73`, `Community 78`, `Community 82`, `Community 211`, `Community 212`, `Community 213`, `Community 214`, `Community 216`, `Community 218`, `Community 93`, `Community 222`, `Community 226`, `Community 232`, `Community 110`, `Community 116`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 48` to `Community 2`, `Community 4`, `Community 8`, `Community 9`, `Community 12`, `Community 13`, `Community 14`, `Community 19`, `Community 24`, `Community 25`, `Community 26`, `Community 158`, `Community 30`, `Community 38`, `Community 44`, `Community 47`, `Community 51`, `Community 58`, `Community 60`, `Community 188`, `Community 72`, `Community 84`, `Community 212`, `Community 213`, `Community 225`, `Community 99`, `Community 233`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `strapiGet()` connect `Community 223` to `Community 1`, `Community 4`, `Community 6`, `Community 15`, `Community 17`, `Community 18`, `Community 20`, `Community 149`, `Community 27`, `Community 32`, `Community 33`, `Community 40`, `Community 41`, `Community 170`, `Community 43`, `Community 46`, `Community 47`, `Community 49`, `Community 55`, `Community 57`, `Community 62`, `Community 74`, `Community 215`, `Community 218`?**
