...
var __dsPreview = (() => {
  ...
  function Default() {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Button, { onClick: () => {
    }, size: "lg", className: "w-full max-w-xs", children: "Return to Platform" });
  }
  function Outline() {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Button, { variant: "outline", onClick: () => {
      }, children: "Cancel" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Button, { variant: "outline", size: "icon", className: "h-12 w-12 rounded-full border-neutral-300 hover:bg-neutral-100", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Search, { className: "h-5 w-5" }) })
    ] });
  }
  function Destructive() {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Button, { variant: "destructive", onClick: () => {
    }, children: "Delete Account" });
  }
  function Ghost() {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Button, { variant: "ghost", onClick: () => {
    }, children: "Skip for now" });
  }
  function WithIcon() {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(Button, { variant: "outline", size: "sm", className: "gap-2", onClick: () => {
    }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(UserPlus, { className: "h-4 w-4" }),
      "Invite Friend"
    ] });
  }
  function Loading() {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(Button, { disabled: true, className: "bg-primary hover:bg-primary/90", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(LoaderCircle, { className: "h-4 w-4 mr-2 animate-spin" }),
      "Sending..."
    ] });
  }
  function Disabled() {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(Button, { disabled: true, onClick: () => {
    }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Share2, { className: "mr-2 h-4 w-4" }),
      "Share to Repository"
    ] });
  }
